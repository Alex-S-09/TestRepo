...
class ColorSensor() {
    ...
    fun initialize() {
        colorSensor = OpModeManager.hardwareMap.get(RevColorSensorV3::class.java, "colorSensor")

        initializeInternalColorSensorHandler()

        colorSensor.gain = 20.0f
    }

    fun initializeInternalColorSensorHandler () {
    ...
    fun periodic() {
        ...
        // colors and hsv have same data
        // distance has distance
        // todo do detection logic here

        // todo do telemetry logic here
